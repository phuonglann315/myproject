...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $query = "INSERT INTO BRAND (IDBR,NAMEBR) VALUES ('str',?)";
    $param = [
        $_POST['NAMEBR']
    ];
                    ...
                    <div class="tab-pane fade show active" id="pills-insert-brand">
                        <div class="my-account-address my-account-details account-wrapper mt-6">
                            <form method="POST" enctype="multipart/form-data">
                                <h4 class="account-title">Insert new brand</h4>
                                <div class="account-details">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="single-form">
                                                <label class="form-label mt-0" for="NAMEBR">Brand Name<span
                                                        class="required">*</span></label>
                                                <input type="text" value="" name="NAMEBR" id="NAMEBR">
                                            </div>
                                        </div>
                                        <div class="col-md-">
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)):
                                                    ...
                                                    <tr>
                                                        <td><?= $row["IDBR"]; ?></td>
                                                        <td><?= $row["NAMEBR"]; ?></td>
                                                        <td><?= $row["STTBRAND"] ? "Active" : "Blocked"; ?></td>
                                                        <td><a href=BRAND_EDIT.php?IDBR=<?= $row["IDBR"] ?>>
