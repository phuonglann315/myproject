...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $query = "UPDATE BRAND SET NAMEBR = ?, STTBRAND= ? WHERE IDBR = ?";
    $param = [
        $_POST['NAMEBR'],
        $_POST['STTBRAND'],
        $_GET['IDBR']
                    ...
                    <div class="tab-pane fade show active" id="pills-insert-brand">
                        <div class="my-account-address my-account-details account-wrapper mt-6">
                            <form method="POST" enctype="multipart/form-data">
                                <h4 class="account-title">Edit brand</h4>
                                <div class="account-details">
                                    <div class="row">

                                        <div class="col-md-6">
                                            <div class="single-form">
                                                <label for="IDBR" class="form-label mt-0">ID BRAND</label>
                                                <input type="text" name="IDBR" id="IDBR"
                                                       value="<?= $row['IDBR']; ?>" disabled><br/>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="single-form">
                                                <label class="form-label mt-0" for="NAMEBR">Brand Name</label>
                                                <input type="text" value="<?= $row['NAMEBR']; ?>" name="NAMEBR"
                                                       id="NAMEBR">
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <input class="form-check" type="checkbox" name="STTBRAND" id="STTBRAND"
                                                <?= $row['STTBRAND'] ? "checked" : ""; ?>>
                                        </div>
                                        <div class="col-md-">
                                            <label for="STTBRAND" class="form-check-label">
